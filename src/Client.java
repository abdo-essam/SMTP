            ...
            while (running) {
                ...
                if (entry.length() >=4 && entry.equalsIgnoreCase("QUIT")) {
                    ...
                    // MAIL FROM message
                        ...
                        if (!((entry.length() >= (username.length()+10)) && (entry.equals(username + "@fci-cu.edu.eg")))) {
                            System.out.println
                            ("From email doesn't match login, must be of form username@fci-cu.edu.eg");
                            System.out.print("From: ");
                            entry = input.readLine();
                        }
                    ...
                    // RCPT TO message
                        ...
                        Pattern pattern = Pattern.compile("^(.+)@fci-cu.edu.eg$"); // don't
                        Matcher matcher = pattern.matcher(entry);// don't
                        // case 1: email not of correct form
                        if (!matcher.matches()) {
                            System.out.println("To email must be of form example@fci-cu.edu.eg");
                            System.out.print("To: ");
                            entry = input.readLine();
                        }
                        else {
